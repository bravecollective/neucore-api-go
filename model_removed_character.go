...
// checks if the RemovedCharacter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemovedCharacter{}
...
func (o RemovedCharacter) ToMap() (map[string]interface{}, error) {
