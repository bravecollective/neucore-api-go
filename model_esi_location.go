...
// checks if the EsiLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EsiLocation{}
...
func (o EsiLocation) ToMap() (map[string]interface{}, error) {
