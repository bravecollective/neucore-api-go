...
*ApplicationCharactersApi* | [**PlayersV1**](docs/ApplicationCharactersApi.md#playersv1) | **Post** /app/v1/players | Returns player accounts identified by character IDs. Can contain the same player several times.
...
*ApplicationESIApi* | [**EsiAccessTokenV1**](docs/ApplicationESIApi.md#esiaccesstokenv1) | **Get** /app/v1/esi/access-token/{characterId} | Returns an access token for a character and EVE login.
...
## Documentation For Models
 ...
 - [EsiAccessToken](docs/EsiAccessToken.md)
 ...
 - [PlayerWithCharcterId](docs/PlayerWithCharcterId.md)
