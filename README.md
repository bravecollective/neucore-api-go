...
*ApplicationESIApi* | [**EsiEveLoginCharactersV1**](docs/ApplicationESIApi.md#esievelogincharactersv1) | **Get** /app/v1/esi/eve-login/{name}/characters | Returns character IDs of characters that have a valid ESI token of the specified EVE login.
...
## Documentation For Models
 ...
 - [ServiceConfigurationURL](docs/ServiceConfigurationURL.md)
