...
*ApplicationESIApi* | [**EsiEveLoginTokenDataV1**](docs/ApplicationESIApi.md#esievelogintokendatav1) | **Get** /app/v1/esi/eve-login/{name}/token-data | Returns data of valid tokens for an EVE login.
