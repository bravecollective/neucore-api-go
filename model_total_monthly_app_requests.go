...
// checks if the TotalMonthlyAppRequests type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TotalMonthlyAppRequests{}
...
func (o TotalMonthlyAppRequests) ToMap() (map[string]interface{}, error) {
