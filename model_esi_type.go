...
// checks if the EsiType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EsiType{}
...
func (o EsiType) ToMap() (map[string]interface{}, error) {
