...
// checks if the PlayerLoginStatistics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerLoginStatistics{}
...
func (o PlayerLoginStatistics) ToMap() (map[string]interface{}, error) {
