...
func (r ApiPlayersV1Request) Execute() ([]Player, *http.Response, error) {
	return r.ApiService.PlayersV1Execute(r)
}

/*
PlayersV1 Returns player accounts identified by character IDs.
...
// Execute executes the request
//  @return []Player
func (a *ApplicationCharactersApiService) PlayersV1Execute(r ApiPlayersV1Request) ([]Player, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
